...
export const CyberBrawlerGame: React.FC<ArcadeGameProps> = ({ onExit, machineName }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-neutral-950 text-white font-mono select-none overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-amber-950 via-neutral-900 to-amber-950 border-b border-amber-500/70 px-2 py-1 sm:px-4 sm:py-1.5 flex items-center justify-between shadow-md shrink-0">
        <div className="flex items-center gap-1.5 sm:gap-2 truncate">
          ...
          <div className="truncate">
            <h1 className="text-xs sm:text-sm font-black text-amber-300 tracking-wider flex items-center gap-1.5 truncate">
              CYBER PUNCHOUT <span className="hidden xs:inline text-[9px] px-1 py-0.2 rounded bg-amber-600/30 text-amber-200 border border-amber-500/50">CHAMPIONSHIP</span>
            </h1>
            <p className="hidden sm:inline-block text-[10px] text-neutral-400">Bout {currentBout + 1}</p>
          </div>
        </div>

        <div className="flex items-center gap-1.5 sm:gap-2 text-xs shrink-0">
          <div className="text-[11px] text-neutral-300">
            PTS:<span className="text-amber-400 font-bold ml-0.5">{score}</span>
          </div>
