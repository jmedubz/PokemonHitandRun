...
export const CyberBreakoutGame: React.FC<ArcadeGameProps> = ({ onExit, machineName }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-neutral-950 text-white font-mono select-none overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-cyan-950 via-neutral-900 to-sky-950 border-b border-cyan-500/70 px-2 py-1 sm:px-4 sm:py-1.5 flex items-center justify-between shadow-md shrink-0">
        <div className="flex items-center gap-1.5 sm:gap-2 truncate">
          ...
          <div className="truncate">
            <h1 className="text-xs sm:text-sm font-black text-cyan-300 tracking-wider flex items-center gap-1.5 truncate">
              CYBER BREAKOUT <span className="hidden xs:inline text-[9px] px-1 py-0.2 rounded bg-cyan-600/30 text-cyan-200 border border-cyan-500/50">ARKANOID</span>
            </h1>
            <p className="hidden sm:inline-block text-[10px] text-neutral-400">Level {level}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 text-xs shrink-0">
          ...
          <div className="text-[11px] text-neutral-200">
            PTS:<span className="text-cyan-300 font-black ml-0.5">{score}</span>
          </div>
