...
export const GalaxyDefenderGame: React.FC<ArcadeGameProps> = ({ onExit, machineName }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-neutral-950 text-white font-mono select-none overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-sky-950 via-slate-900 to-indigo-950 border-b-2 border-cyan-500/70 px-3 sm:px-6 py-2 flex items-center justify-between shadow-lg shrink-0">
        <div className="flex items-center gap-2 sm:gap-3">
          <Zap className="w-5 h-5 text-cyan-400 animate-pulse" />
          <div>
            <h1 className="text-sm sm:text-lg font-black text-cyan-300 tracking-wider">
              GALAXY DEFENDER <span className="text-[10px] px-1.5 py-0.5 rounded bg-cyan-600/30 text-cyan-200 border border-cyan-500/50">ARCADE PRO</span>
            </h1>
            <p className="text-[10px] text-slate-400">Sector {sector} of 4 • Swarm Defense</p>
          </div>
        </div>
